...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <div><a class="btn btn-primary" href="../auth/" role="button">Login</a><div>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form action="../main" method="POST" enctype="multipart/form-data" id="saveTask">
                ...
                <input type="text" name="action" value="create" style="display:none;" class="form-control">
